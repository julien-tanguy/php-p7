...
<html lang="fr" dir="ltr">
    <head>
        ...
        <title>php - e8p7 user page</title>
    </head>
    <body>
    ...
    //si la method d'envoie est post
        ...
        <p><?php echo 'Bonjour ' . $_POST['civilité'] . ', votre nom est : ' . $_POST['lastname'] . ' et votre prénom : ' . $_POST['firstname'] . '. Vous avez Transmis le fichier : ' . $_FILES['files']['name'] . ' de type : ' . $_FILES['files']['type']; ?></p><?php 
            ...
            <p><?php echo 'Bonjour ' . $_POST['civilité'] . ', votre nom est : ' . $_POST['lastname'] . ' et votre prénom : ' . $_POST['firstname'] . '. Veuillez inserer un fichier pdf a votre formulaire.'; ?></p><?php 
        }else { ?>
            <p><?php echo 'Fichier invalide, le fichier transmis doit être un PDF.'; ?></p><?php }
